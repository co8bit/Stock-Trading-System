...
<div class="row-fluid">
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="tools">
									...
									<a href="<?php echo U('Root/putongUserAuthIndex');?>" class="reload"></a>
						...
						<div class="btn-group">
				<button class="btn blue dropdown-toggle" data-toggle="dropdown">  设置  <i class="icon-angle-down"></i>
					</button>
									<ul class="dropdown-menu bottom-up opens-left">
									<li><button  class="btn blue dropdown-toggle" type="submit" name="delete_stock" onclick="stock_manage_choose(this.name)">删除股票</button></li>
									<li class="divider"></li>
									<li><button  class="btn blue dropdown-toggle" type="submit" name="change_auth_stock" onclick="stock_manage_choose(this.name)">修改股票权限</button></li>
...
<div class="portlet box light-grey">
                ...
                <input name="new_stock_add_btn" type="submit" value="添加" onclick="stock_add_button()" class="btn blue dropdown-toggle" >   
